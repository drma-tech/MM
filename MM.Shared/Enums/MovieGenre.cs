...
{
    [Custom(Name = "ActionAdventure", Description = "ActionAdventure_Description",
        ResourceType = typeof(Resources.MovieGenre))]
    ActionAdventure = 1,
    ...
    [Custom(Name = "FantasyMythology", Description = "FantasyMythology_Description",
        ResourceType = typeof(Resources.MovieGenre))]
    FantasyMythology = 5,

    [Custom(Name = "HorrorThriller", Description = "HorrorThriller_Description",
        ResourceType = typeof(Resources.MovieGenre))]
    HorrorThriller = 6,

    [Custom(Name = "ScienceFiction", Description = "ScienceFiction_Description",
        ResourceType = typeof(Resources.MovieGenre))]
    ScienceFiction = 7,
    ...
    [Custom(Name = "MysteryCrime", Description = "MysteryCrime_Description",
        ResourceType = typeof(Resources.MovieGenre))]
    MysteryCrime = 9,

    [Custom(Name = "HistoricalBiographical", Description = "HistoricalBiographical_Description",
        ResourceType = typeof(Resources.MovieGenre))]
    HistoricalBiographical = 10,

    [Custom(Name = "MusicalDance", Description = "MusicalDance_Description",
        ResourceType = typeof(Resources.MovieGenre))]
    MusicalDance = 11,
