namespace MM.Shared.Enums
{
    ...
    {
        [Custom(Name = "White_Name", Description = "White_Description", ResourceType = typeof(Resources.RaceCategory))]
        White = 1,

        [Custom(Name = "BlackAfricanAmerican_Name", Description = "BlackAfricanAmerican_Description", ResourceType = typeof(Resources.RaceCategory))]
        BlackAfricanAmerican = 2,

        [Custom(Name = "AmericanIndianAlaskaNative_Name", Description = "AmericanIndianAlaskaNative_Description", ResourceType = typeof(Resources.RaceCategory))]
        AmericanIndianAlaskaNative = 3,

        [Custom(Name = "Asian_Name", Description = "Asian_Description", ResourceType = typeof(Resources.RaceCategory))]
        Asian = 4,

        [Custom(Name = "NativeHawaiianOtherPacificIslander_Name", Description = "NativeHawaiianOtherPacificIslander_Description", ResourceType = typeof(Resources.RaceCategory))]
        NativeHawaiianOtherPacificIslander = 5,

        [Custom(Name = "TwoMoreRaces_Name", Description = "TwoMoreRaces_Description", ResourceType = typeof(Resources.RaceCategory))]
        TwoMoreRaces = 6,

        [Custom(Name = "Other_Name", Description = "Other_Description", ResourceType = typeof(Resources.RaceCategory))]
        Other = 7
    }
