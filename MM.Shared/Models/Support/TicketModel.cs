...
namespace MM.Shared.Models.Support
{
    public class TicketModel : ProtectedMainDocument
    {
        ...
        [Required]
        [Custom(Name = "TitleName", Placeholder = "TitlePlaceholder", ResourceType = typeof(Resources.TicketModel))]
        public string? Title { get; set; }

        [Required]
        [Custom(Name = "DescriptionName", Placeholder = "DescriptionPlaceholder", ResourceType = typeof(Resources.TicketModel))]
