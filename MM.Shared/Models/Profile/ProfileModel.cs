...
public class ProfileModel : CosmosDocument
{
    ...
    [FieldSettings("NickName_Name", Placeholder = "NickName_Placeholder", ResourceType = typeof(ProfileBasicModel))]
    public string? NickName { get; set; }

    [FieldSettings("Description_Name", Placeholder = "Description_Placeholder", ResourceType = typeof(ProfileBasicModel))]
    public string? Description { get; set; }

    [FieldSettings("Nationality_Name", ResourceType = typeof(ProfileBasicModel))]
    public Country? Nationality { get; set; }

    [JsonIgnore]
    [FieldSettings("Location_Name", Placeholder = "Location_Placeholder", Description = "Location_Description",
    ...
    [FieldSettings("Languages_Name", Description = "Languages_Description",
    ...
    [FieldSettings("MaritalStatus_Name",
    ...
    [FieldSettings("BiologicalSex_Name",
    ...
    [FieldSettings("GenderIdentity_Name", Description = "GenderIdentity_Description",
    ...
    [FieldSettings("SexualOrientation_Name", Description = "SexualOrientation_Description",
    ...
    [FieldSettings("BirthDate_Name", ResourceType = typeof(ProfileBioModel))]
    ...
    [FieldSettings("Disabilities_Name",
    ...
    [FieldSettings("Diet_Name", Description = "Diet_Description",
    ...
    [FieldSettings("FamilyInvolvement_Name", Description = "FamilyInvolvement_Description",
    ...
    [FieldSettings("HaveChildren_Name",
    ...
    [FieldSettings("EducationLevel_Name",
    ...
    [FieldSettings("CareerCluster_Name",
    ...
    [FieldSettings("LivingSituation_Name",
    ...
    [FieldSettings("TravelFrequency_Name",
    ...
    [FieldSettings("NetWorth_Name", Description = "NetWorth_Description",
    ...
    [FieldSettings("AnnualIncome_Name", Description = "AnnualIncome_Description",
    ...
    [FieldSettings("MoneyPersonality_Name", Description = "MoneyPersonality_Description",
    ...
    [FieldSettings("SharedSpendingStyle_Name",
    ...
    [FieldSettings("RelationshipPersonality_Name", Description = "RelationshipPersonality_Description",
    ...
    [FieldSettings("MBTI_Name", Description = "MBTI_Description",
    ...
    [FieldSettings("LoveLanguage_Name", Description = "LoveLanguage_Description",
    ...
    [FieldSettings("SexPersonality_Name", Description = "SexPersonality_Description",
    ...
    [FieldSettings("SexPersonalityPreferences_Name", Description = "SexPersonalityPreferences_Description",
        ResourceType = typeof(ProfileLifestyleModel))]
    ...
    [FieldSettings("ConflictResolutionStyle",
    ...
    [FieldSettings("HouseholdManagement",
    ...
    [FieldSettings("TimeTogetherPreference",
    ...
    [FieldSettings("OppositeSexFriendships", Description = "OppositeSexFriendships_Description",
    ...
    [FieldSettings("RelationshipIntentions",
    ...
    [FieldSettings("IdealPlaceToLive",
