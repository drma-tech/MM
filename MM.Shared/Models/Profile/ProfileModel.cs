...
public class ProfileModel : CosmosDocument
{
    ...
    [Custom(Name = "BirthDate_Name", ResourceType = typeof(ProfileBioModel))]
    public DateTime? BirthDate { get; set; }

    [Custom(Name = "Height_Name", ResourceType = typeof(ProfileBioModel))]
    ...
    [Custom(Name = "Religion_Name",
        WhyImportant =
            "Apesar de que algumas pesquisas indiquem que crenças religiosas não é um fator chave no sucesso do relacionamento, isso pode diminuir bastante conflitos na comunicação/forma de pensar dos parceiros ou até mesmo no relacionamento com amigos e familiares. A depender do país/religião/cultura, poderá existir muitas restrições quanto a relacionamentos entre pessoas de religiões diferentes.",
    ...
    [Custom(Name = "NetWorth_Name", Description = "NetWorth_Description", ResourceType = typeof(ProfileLifestyleModel))]
