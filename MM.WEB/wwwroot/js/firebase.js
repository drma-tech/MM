...
if (!isBot && !isPrintScreen) {
    ...
    onAuthStateChanged(auth, async (user) => {
        ...
        await interop.invokeDotNetWhenReady("MM.WEB", "AuthChanged", token);
                ...
                refreshTokenInterval = setInterval(
                    async () => {
                        ...
                        if (user) {
                            ...
                            await interop.invokeDotNetWhenReady("MM.WEB", "AuthChanged", null);
...
export const messaging = {
    async requestMessagingPermission() {
        ...
        await interop.invokeDotNetWhenReady("MM.WEB", "SubscribeToTopics", {
            token,
            platform,
        });
    },
