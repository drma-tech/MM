    ...
    public static void AddLanguages(this ProfileModel profile, Country? country)
    {
        ...
        switch (country)
        {
            ...
            case Country.Ethiopia:
                profile.Languages =
                    [Language.Afar, Language.Amharic, Language.Oromo, Language.Somali, Language.Tigrinya];
                break;
            ...
            case Country.Indonesia:
                profile.Languages =
                [
                    Language.Indonesian, Language.Malay, Language.Javanese, Language.Sundanese
            ...
            case Country.Luxembourg:
                profile.Languages =
                    [Language.French, Language.German, Language.Luxembourgish, Language.English, Language.Portuguese];
                break;
            ...
            case Country.Mali:
                profile.Languages =
                [
                    Language.Bambara, Language.Fulah
                ]; //Bobo, Bozo, Dogon, Hassaniya, Kassonke, Maninke, Minyanka, Senufo, Songhay languages, Soninke, Tamasheq
                break;
            ...
            case Country.Zimbabwe:
                profile.Languages =
                [
                    Language.English, Language.NorthNdebele, Language.Shona, Language.SouthernSotho, Language.Tonga,
                    Language.Tswana, Language.Venda, Language.Xhosa
                ]; //many others
                break;
        }
    }
