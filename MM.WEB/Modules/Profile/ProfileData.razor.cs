        ...
        if (Profile == null && AppStateStatic.IsAuthenticated)
        {
            ...
            if (language == AppLanguage.pt)
            {
                var message = new MarkupString(
                    ...
                    "Consulte nossa <a href=\"/legal/privacy\" target=\"_blank\" style=\"color: var(--mud-palette-primary)\">Política de Privacidade</a> e nossos <a href=\"/legal/terms\" target=\"_blank\" style=\"color: var(--mud-palette-primary)\">Termos de Uso</a>."
                );
            ...
            else if (language == AppLanguage.es)
            {
                var message = new MarkupString(
                    ...
                    "Consulte nuestra <a href=\"/legal/privacy\" target=\"_blank\" style=\"color: var(--mud-palette-primary)\">Política de Privacidad</a> y nuestros <a href=\"/legal/terms\" target=\"_blank\" style=\"color: var(--mud-palette-primary)\">Términos de Uso</a>."
                );
            ...
            else //English
            {
                var message = new MarkupString(
                     ...
                     "See our <a href=\"/legal/privacy\" target=\"_blank\" style=\"color: var(--mud-palette-primary)\">Privacy Policy</a> and <a href=\"/legal/terms\" target=\"_blank\" style=\"color: var(--mud-palette-primary)\">Terms of Use</a>."
                 );
