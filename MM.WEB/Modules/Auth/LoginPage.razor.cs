    ...
    public partial class LoginPage
    {
        ...
        public static string? SuggestEmailCorrection(string? email)
        {
            ...
            var closest = KnownDomains
                .Select(d => new { Domain = d, Distance = MM.Shared.Core.Helper.StringHelper.Levenshtein(domain, d) })
